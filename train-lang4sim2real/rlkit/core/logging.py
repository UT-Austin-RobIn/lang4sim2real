...
class Logger(object):
    ...
    def set_must_save_snapshot_epochs(self, epochs):
        self._must_save_snapshot_epochs = epochs
    ...
    def save_itr_params(self, itr, params):
        if self._snapshot_dir:
            ...
            if itr in self._must_save_snapshot_epochs:
                file_name = osp.join(self._snapshot_dir, 'itr_%d' % itr)
                self._save_params_to_file(
                    params, file_name, mode=self._save_param_mode)
...
def setup_logger(
    ...
    logger.set_must_save_snapshot_epochs(must_save_snapshot_epochs)
