...
from robosuite.utils.mjcf_utils import (
    array_to_string, find_elements, xml_path_completion)
...
class MilkSmallObject(MujocoXMLObject):
    """
    Milk carton object, but 50% shorter (used in PickPlace)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/milk_small.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class CerealSmallObject(MujocoXMLObject):
    """
    Cereal carton object 70% size of CerealObject (used in PickPlace)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/cereal_small.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class StoveObject(MujocoXMLObject):
    """
    Stove object (used in PickPlace)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/small_flat_stove.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
...
class StringObject(MujocoXMLObject):
    """
    String object (used in WrapWire)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/string.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class StringObject2(MujocoXMLObject):
    """
    String object with different colors (used in WrapWire)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/string2.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class PostObject(MujocoXMLObject):
    """
    Post object (used in WrapWire)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/post.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class PostObject2(MujocoXMLObject):
    """
    Post object with different colors (used in WrapWire)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/post2.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class SpoolAndWireObject(MujocoXMLObject):
    """
    Bread loaf object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/spool_and_wire.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
...
class SingleBall(MujocoXMLObject):
    """
    Bread loaf object (used in PickPlace)
    """
    ...
    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/box_25_spheres.xml"),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
