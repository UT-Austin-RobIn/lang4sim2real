...
from .panda_gripper import PandaGripper, PandaGripperBlack
...
from .robotiq_three_finger_gripper import (
    RobotiqThreeFingerGripper, RobotiqThreeFingerDexterousGripper)
from .jaco_three_finger_gripper import (
    JacoThreeFingerGripper, JacoThreeFingerDexterousGripper)
...
GRIPPER_MAPPING = {
    ...
    "PandaGripperBlack": PandaGripperBlack,
