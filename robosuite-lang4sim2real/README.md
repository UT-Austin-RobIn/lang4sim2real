# robosuite-lang4sim2real
This is our version of the [original robosuite repo](https://github.com/ARISE-Initiative/robosuite) with our 3 sim environments (pick-and-place, 2-step pick-and-place, and wire wrap) and associated scripted policies to collect data.

Important files and folders added on top of the original robosuite:
- **Multitask sim envs**: All three in [this file](./robosuite/environments/manipulation/multitask.py)
- **Scripted Policies**: [pick-place](./robosuite/policies/pick_place.py), [wrap wire](./robosuite/policies/wrap_policy.py)
- **Data collection scripts**: [multi-threaded](./robosuite/scripts/collect_demonstrations_parallel.py), [single-threaded](./robosuite/scripts/collect_demonstrations.py)
- **HDF5 utils**: [read](./robosuite/scripts/read_hdf5.py), [concat](./robosuite/scripts/concat_hdf5.py)

We also removed the files for all non-Panda robots and `docs/` to streamline this folder and save space.
