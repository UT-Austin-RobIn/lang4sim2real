...
def algo_factory(algo_name, config, obs_key_shapes, ac_dim, device, env_algo_kwargs):
    """
    ...
    Args:
        ...
        env_algo_kwargs (dict): Additional args env-specific for the algo_cls.
    """
    ...
    print("algo_cls", algo_cls)

    algo_kwargs.update(env_algo_kwargs)
